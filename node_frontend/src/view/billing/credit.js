...
export default function Credit() {
  ...
  const icons = [
    ...
    { component: <QueuePlayNextIcon />, label: 'credit', onClick: () => console.log('Edit clicked') },
...
<div className='datatable' style={{ marginTop:"20px",width:"98%",marginLeft:"10px",paddingLeft:"0px" }}>
