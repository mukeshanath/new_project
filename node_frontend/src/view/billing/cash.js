...
export default function Cash() {
  ...
  const icons = [
    ...
    { component: <ListAltIcon />, label: 'Cashlist', onClick: () => console.log('Edit clicked') },
    { component: <QueuePlayNextIcon />, label: 'Cash', onClick: () => console.log('Edit clicked') },
